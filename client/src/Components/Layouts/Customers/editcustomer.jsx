                    ...
                    >
                        <Form className='modalform'>
                                ...
                                <div className='modalform'>
                                    <Form.Item label="الهاتف" layout="horizontal" className='modalform_phone'>
                                        {getFieldDecorator('phone',
                                            {
                                                initialValue: this.props.information.s_mobile_number ? this.props.information.s_mobile_number.substr(3) : '',
                                                rules: [
                                                    {
                                                        required: true,
                            ...
                            <div className='modalform__left-container'>
                                ...
                                <Form.Item
                                    label={<span>كلمة المرور الحالية</span>}
                                >
                                    {getFieldDecorator('oldpassword', {
                                        rules: [{ required: true, message: 'يرجى ادخال كلمة المرور الحالية' }],
                                    })(
                                        <Input className='passwordinput' type='password' />)}
                                </Form.Item>
                                <Form.Item
                                    label={<span>كلمة المرور الجديدة</span>}
                                >
